...
// `external: false` (default) → uses react-router-dom's <Link> for in-app routes.
const footerGroups = [
  {
    title: "Product",
    links: [
      ...
      { label: "AI Setup Bot", href: "/setup-bot" },
  ...
  },
  {
    title: "Community",
    links: [
      { label: "X/Twitter", href: "https://twitter.com/wheedleai", external: true },
      { label: "LinkedIn", href: "https://linkedin.com/company/wheedle-ai", external: true },
      { label: "Discord", href: "https://discord.gg/wheedle-ai", external: true },
...
const socialLinks = [
  { platform: "linkedin", href: "https://linkedin.com/company/wheedle-ai" },
  { platform: "twitter", href: "https://twitter.com/wheedleai" },
  { platform: "facebook", href: "https://facebook.com/wheedleai" },
  { platform: "youtube", href: "https://youtube.com/@wheedleai" },
];

function SocialIcon({ children, platform, href }) {
  const getPlatformColor = () => {
    switch (platform) {
      case "linkedin":
        return "hover:border-[#0A66C2]";
      case "twitter":
        return "hover:border-[#1DA1F2]";
      case "facebook":
        return "hover:border-[#1877F2]";
      case "youtube":
        return "hover:border-[#FF0000]";
      default:
...
function FooterLink({ href, external, children }) {
  const className =
    "group relative inline-block text-white/70 transition-all duration-300 hover:text-white";
        ...
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div>
            ...
            <p className="mt-5 max-w-[360px] text-sm leading-relaxed text-white/70">
              We're building the future of automated commerce. Wheedle.ai uses
              state-of-the-art Generative AI to manage world-class marketing
            ...
            <form
              ...
              onSubmit={(e) => {
                ...
                // Hook up to your real subscribe endpoint here.
            ...
            >
              <div className="flex max-w-[360px] gap-2">
                ...
                <button
                  type="submit"
                  className="rounded-xl bg-gradient-to-r from-[#0665ff] via-[#0665ff] to-[#22d3ee] px-4 py-2.5 text-sm font-medium text-white transition-all duration-300 hover:scale-105 hover:shadow-lg"
                >
                  Subscribe
                </button>
              </div>
