...
export const Campaigns: React.FC = () => {
  ...
  if (!isChatMode) {
    return (
      <>
        <style>{CSS}</style>
        <div style={{ background: 'var(--bg-elevated)', color: 'var(--text-primary)', position: 'fixed', zIndex: 9999, width: '80%' }}><Header /></div>
...
const CSS = `
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .restore-banner-title { font-size: 0.88rem; font-weight: 700; color: var(--text-primary); margin-bottom: 3px; }
  .restore-banner-sub { font-size: 0.75rem; color: var(--text-dim); }
  .restore-banner-sub strong { color: var(--text-secondary); }
  ...
  .restore-btn-secondary:hover { color: var(--text-dim); border-color: var(--glass-border); }
  ...
  .land-root { position: relative; min-height: calc(100vh - 68px); background: var(--bg-primary); overflow: hidden; display: flex; align-items: center; justify-content: center; font-family: 'Space Grotesk', sans-serif; }
  ...
  .land-headline { font-size: clamp(2.6rem, 6vw, 4.2rem); font-weight: 700; line-height: 1.08; letter-spacing: -0.03em; color: var(--text-primary); margin: 0 0 6px; }
  .land-headline-line2 { display: block; margin-top: 4px; }
  .land-hl-static { background: linear-gradient(135deg, var(--text-primary) 0%, var(--text-secondary) 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  ...
  .land-sub { font-size: 1.05rem; line-height: 1.7; color: var(--text-dim); margin: 20px 0 36px; max-width: 600px; }
  .land-input-section { width: 100%; max-width: 680px; margin-bottom: 24px; }
  .land-input-shell { display: flex; align-items: center; background: var(--glass-bg); border: 1px solid rgba(99,102,241,0.3); border-radius: 14px; padding: 6px 6px 6px 16px; transition: border-color 0.2s, box-shadow 0.2s; }
  ...
  .land-url-input { flex: 1; background: transparent; border: none; outline: none; font-size: 0.95rem; color: var(--text-primary); font-family: 'JetBrains Mono', monospace; padding: 12px 0; min-width: 0; }
  .land-url-input::placeholder { color: var(--text-secondary); font-family: 'Space Grotesk', sans-serif; }
  .land-cta-btn { display: flex; align-items: center; gap: 8px; flex-shrink: 0; padding: 13px 24px; border-radius: 10px; background: linear-gradient(135deg, #0665ff 50%, #22d3ee 100%); border: none; color: var(--text-primary); font-size: 0.88rem; font-weight: 700; cursor: pointer; white-space: nowrap; transition: all 0.2s; box-shadow: 0 4px 16px rgba(99,102,241,0.35); }
  ...
  .land-input-hint { display: flex; align-items: center; justify-content: center; gap: 6px; margin-top: 12px; color: var(--text-secondary); font-size: 0.75rem; }
  .land-platforms { display: flex; flex-direction: column; align-items: center; gap: 12px; margin-bottom: 40px; }
  .land-platforms-label { font-size: 0.72rem; color: var(--text-secondary); letter-spacing: 0.08em; text-transform: uppercase; }
  .land-platform-icons { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; justify-content: center; }
  .land-platform-pill { display: flex; align-items: center; gap: 7px; padding: 7px 14px; border-radius: 8px; background: var(--bg-card); border: 1px solid var(--glass-border); font-size: 0.8rem; font-weight: 600; color: var(--text-dim); transition: all 0.2s; }
  .land-platform-pill:hover { border-color: var(--pc); color: var(--text-secondary); transform: translateY(-2px); }
  .land-stats { display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; width: 100%; margin-bottom: 56px; }
  .land-stat-card { background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 14px; padding: 20px 16px; display: flex; flex-direction: column; align-items: center; gap: 6px; transition: all 0.25s; }
  ...
  .land-stat-value { font-size: 1.7rem; font-weight: 700; color: var(--text-primary); line-height: 1; }
  .land-stat-label { font-size: 0.7rem; color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.06em; }
  .camp-chat-page { width: 100%; min-height: calc(100vh - 68px); background: var(--bg-primary); display: flex; flex-direction: column; }
  ...
  .camp-avatar { width: 36px; height: 36px; border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; color: var(--text-primary); }
  .camp-avatar.bot { background: linear-gradient(135deg, #002f7a, #4f91fc); }
  .camp-avatar.user { background: var(--bg-elevated); border: 1px solid var(--glass-border); }
  .camp-user-dot { width: 9px; height: 9px; background: #38bdf8; border-radius: 50%; }
  .camp-msg-body { max-width: calc(100% - 54px); }
  .camp-bubble-bot { padding: 14px 18px; border-radius: 4px 16px 16px 16px; background: var(--bg-card); border: 1px solid var(--glass-border); line-height: 1.6; color: var(--text-primary); white-space: pre-line; font-size: 0.9rem; }
  ...
  .camp-bubble-user { padding: 12px 18px; border-radius: 16px 4px 16px 16px; background: linear-gradient(135deg, rgba(37,99,235,0.2), rgba(124,58,237,0.15)); border: 1px solid rgba(59,130,246,0.2); color: var(--text-primary); font-size: 0.9rem; }
  .camp-muted { color: var(--text-dim) !important; font-style: italic; }
  .camp-loading-row { display: flex; gap: 14px; align-items: center; }
  .camp-ai-thinking { display: flex; align-items: center; gap: 5px; padding: 14px 18px; background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 4px 16px 16px 16px; }
  ...
  .camp-ai-badge { padding: 3px 10px; background: linear-gradient(135deg, #0062ff, #5c97f6); border-radius: 20px; font-size: 0.62rem; font-weight: 700; color: var(--text-primary); white-space: nowrap; }
  .site-preview-card { width: 100%; border-radius: 20px; overflow: hidden; background: var(--bg-elevated); border: 1px solid rgba(59,130,246,0.2); }
  .site-preview-browser-bar { height: 58px; display: flex; align-items: center; justify-content: space-between; padding: 0 18px; background: var(--glass-bg); border-bottom: 1px solid var(--glass-border); }
  ...
  .site-preview-url-bar { display: flex; align-items: center; gap: 8px; padding: 8px 14px; border-radius: 12px; background: var(--bg-card); color: var(--text-secondary); font-size: 13px; }
  ...
  .site-preview-img-wrap { position: relative; width: 100%; height: 220px; background: var(--bg-primary); overflow: hidden; }
  ...
  .site-preview-loading { position: absolute; inset: 0; z-index: 2; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 14px; color: var(--text-primary); background: var(--glass-bg); }
  .site-preview-fallback { position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; background: var(--bg-elevated); color: var(--text-primary); gap: 10px; }
  ...
  .camp-terminal { background: var(--bg-elevated); border: 1px solid var(--glass-border); border-radius: 12px; padding: 16px; font-family: 'Courier New', monospace; margin-top: 6px; min-width: 360px; }
  .camp-terminal-header { display: flex; justify-content: space-between; margin-bottom: 12px; padding-bottom: 8px; border-bottom: 1px solid var(--glass-border); color: var(--text-dim); font-size: 0.72rem; }
  ...
  .brand-form-card { background: var(--glass-bg); border: 1px solid rgba(59,130,246,0.22); border-radius: 16px; padding: 22px; margin-top: 6px; max-width: 580px; }
  ...
  .brand-form-title { font-size: 0.95rem; font-weight: 700; color: var(--text-primary); }
  .brand-form-sub { font-size: 0.72rem; color: var(--text-dim); margin-top: 3px; }
  ...
  .brand-form-label { display: flex; align-items: center; gap: 5px; font-size: 0.72rem; font-weight: 600; color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 7px; }
  .brand-form-input { width: 100%; padding: 11px 14px; background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 10px; color: var(--text-primary); font-size: 0.9rem; outline: none; transition: border-color 0.2s; font-family: inherit; }
  .brand-form-input:focus { border-color: rgba(59,130,246,0.5); background: var(--bg-elevated); }
  .brand-logo-row { display: flex; align-items: flex-start; gap: 12px; }
  .brand-logo-preview { width: 64px; height: 64px; border-radius: 12px; background: var(--bg-card); border: 1px solid var(--glass-border); display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; }
  ...
  .brand-logo-favicon-btn { display: flex; align-items: center; gap: 7px; padding: 9px 14px; background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 9px; color: var(--text-secondary); font-size: 0.78rem; font-weight: 500; cursor: pointer; transition: all 0.2s; }
  ...
  .brand-logo-hint { font-size: 0.68rem; color: var(--text-dim); }
  ...
  .brand-form-submit { width: 100%; padding: 13px; background: linear-gradient(135deg, #3b82f6, #2563eb); border: none; border-radius: 12px; color: var(--text-primary); font-size: 0.92rem; font-weight: 700; display: flex; align-items: center; justify-content: center; gap: 9px; cursor: pointer; transition: all 0.2s; }
  ...
  .bvc-wrap { background: var(--glass-bg); border: 1px solid rgba(59,130,246,0.2); border-radius: 16px; padding: 18px; margin-bottom: 18px; }
  ...
  .bvc-title { font-size: 0.92rem; font-weight: 700; color: var(--text-primary); }
  .bvc-sub { font-size: 0.72rem; color: var(--text-dim); margin-top: 2px; }
  .bvc-section-label { font-size: 0.72rem; color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.07em; margin-bottom: 10px; }
  ...
  .bvc-score-name { font-size: 0.78rem; color: var(--text-secondary); width: 120px; flex-shrink: 0; display: flex; align-items: center; gap: 6px; }
  ...
  .bvc-score-bar-track { flex: 1; height: 8px; background: var(--bg-card); border-radius: 99px; overflow: hidden; }
  ...
  .bvc-insight { display: flex; align-items: flex-start; gap: 8px; padding: 10px 12px; background: rgba(245,158,11,0.07); border: 1px solid rgba(245,158,11,0.2); border-radius: 9px; font-size: 0.76rem; color: var(--text-primary); line-height: 1.5; margin-top: 12px; }
  .promo-obj-card { background: var(--glass-bg); border: 2px solid rgba(0,86,247,0.3); border-radius: 24px; padding: 22px; max-width: 640px; }
  ...
  .promo-obj-header h3 { margin: 0 0 4px; font-size: 1.1rem; font-weight: 700; color: var(--text-primary); }
  .promo-obj-header p { margin: 0; font-size: 0.78rem; color: var(--text-dim); }
  ...
  .promo-field label { font-size: 0.7rem; font-weight: 700; color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.05em; }
  .promo-input { padding: 11px 14px; background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 10px; color: var(--text-primary); font-size: 0.9rem; outline: none; transition: border-color 0.2s; font-family: inherit; width: 100%; }
  .promo-select { padding: 11px 14px; background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 10px; color: var(--text-primary); font-size: 0.9rem; outline: none; font-family: inherit; width: 100%; cursor: pointer; appearance: none; }
  .promo-select option { background: var(--bg-card); color: var(--text-primary); }
  .promo-platform-row { display: flex; gap: 8px; flex-wrap: wrap; }
  .promo-plat-btn { display: flex; align-items: center; gap: 7px; padding: 9px 14px; background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 10px; color: var(--text-dim); font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; }
  ...
  .promo-budget-unit { color: var(--text-dim); font-size: 0.85rem; white-space: nowrap; }
  ...
  .promo-benefit-row { display: flex; align-items: center; gap: 9px; font-size: 0.82rem; color: var(--text-secondary); }
  .benefit-check { color: #10b981; flex-shrink: 0; }
  .promo-actions { display: flex; gap: 12px; }
  .promo-generate-btn { flex: 1; display: flex; align-items: center; justify-content: center; gap: 10px; padding: 14px 20px; background: linear-gradient(135deg, #0073ff, #022b5e); border: none; border-radius: 14px; color: var(--text-primary); font-size: 0.95rem; font-weight: 700; cursor: pointer; transition: all 0.2s; box-shadow: 0 6px 20px rgba(58,142,237,0.35); }
  .promo-generate-btn:hover { transform: scale(1.02); box-shadow: 0 8px 28px rgba(58,136,237,0.5); }
  .audit-card { background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 16px; margin-top: 6px; overflow: hidden; }
  .audit-topbar { display: flex; align-items: center; justify-content: space-between; padding: 16px 20px; border-bottom: 1px solid var(--glass-border); }
  ...
  .audit-brand-name { font-size: 1rem; font-weight: 700; color: var(--text-primary); text-transform: capitalize; }
  .audit-brand-industry { font-size: 0.72rem; color: var(--text-dim); margin-top: 2px; }
  .audit-tabs { display: flex; overflow-x: auto; border-bottom: 1px solid var(--glass-border); padding: 0 16px; scrollbar-width: none; }
  .audit-tabs::-webkit-scrollbar { display: none; }
  .audit-tab { padding: 12px 16px; font-size: 0.78rem; font-weight: 600; color: var(--text-dim); background: transparent; border: none; border-bottom: 2px solid transparent; cursor: pointer; transition: color 0.2s, border-color 0.2s; white-space: nowrap; }
  .audit-tab.active { color: #60a5fa; border-bottom-color: #3b82f6; }
  .audit-panel { padding: 16px; }
  .audit-section-card { background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 12px; padding: 16px; }
  .audit-section-card h4 { margin: 0 0 10px; color: var(--text-primary); font-size: 0.9rem; display: flex; align-items: center; gap: 8px; }
  .audit-info-row { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid var(--glass-border); }
  .audit-info-row:last-child { border-bottom: none; }
  .audit-info-row span { color: var(--text-dim); font-size: 0.82rem; }
  .audit-info-row strong { color: var(--text-primary); }
  .audit-info-row p { color: var(--text-secondary); font-size: 0.8rem; font-style: italic; margin: 0; text-align: right; }
  ...
  .audit-circle { width: 80px; height: 80px; border-radius: 50%; background: var(--bg-card); border: 2px solid rgba(59,130,246,0.3); display: flex; flex-direction: column; align-items: center; justify-content: center; }
  .ac-value { font-size: 1.4rem; font-weight: 800; color: #60a5fa; }
  .ac-label { font-size: 0.6rem; color: var(--text-dim); text-transform: uppercase; }
  .audit-kw-section { margin-bottom: 14px; }
  .audit-kw-section h4 { margin: 0 0 10px; color: var(--text-secondary); font-size: 0.78rem; text-transform: uppercase; }
  ...
  .audit-issue-group-label { font-size: 0.68rem; color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 6px; }
  ...
  .comp-intensity-bar { display: flex; align-items: center; gap: 12px; padding: 12px 14px; background: var(--bg-card); border-radius: 10px; margin-bottom: 12px; }
  .comp-intensity-bar span:first-child { color: var(--text-dim); font-size: 0.78rem; flex-shrink: 0; }
  .comp-bar-track { flex: 1; height: 6px; background: var(--bg-elevated); border-radius: 99px; overflow: hidden; }
  ...
  .competitor-card { background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 12px; padding: 14px; margin-bottom: 10px; }
  .competitor-name { font-size: 0.9rem; font-weight: 700; color: var(--text-primary); margin-bottom: 10px; }
  ...
  .comp-sw-list li { font-size: 0.73rem; color: var(--text-secondary); line-height: 1.4; }
  .audit-analytics-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 10px; margin-bottom: 14px; }
  .aa-metric { background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: 12px; padding: 20px; text-align: center; }
  .aa-value { font-size: 1.5rem; font-weight: 800; color: #60a5fa; margin-bottom: 4px; }
  .aa-label { font-size: 0.7rem; color: var(--text-dim); text-transform: uppercase; }
  ...
  .audit-score-lbl { font-size: 0.52rem; color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.06em; margin-top: 2px; }
  ...
  .gtds-content h3 { margin: 0; font-size: 16px; font-weight: 700; color: var(--text-primary); }
  .gtds-content p { margin: 4px 0 0; opacity: 0.7; font-size: 13px; color: var(--text-secondary); }
  .gtds-info { display: flex; align-items: center; gap: 8px; padding: 10px 14px; background: rgba(0,0,0,0.2); border-radius: 8px; margin-bottom: 16px; color: var(--text-dim); font-size: 0.78rem; }
  .gtds-info code { color: #38bdf8; font-family: monospace; }
  .gtds-progress { width: 100%; height: 8px; border-radius: 999px; background: var(--bg-card); overflow: hidden; margin-top: 18px; margin-bottom: 16px; }
  ...
  .gtds-dashboard-btn { width: 100%; padding: 12px; background: linear-gradient(135deg, #10b981, #059669); border: none; border-radius: 12px; color: var(--text-primary); font-weight: 700; font-size: 0.95rem; display: flex; align-items: center; justify-content: center; gap: 8px; cursor: pointer; }
  .dashboard-wrapper { min-height: 100vh; background: var(--bg-primary); }
  ...
  .brm-title { font-size: 1.15rem; font-weight: 700; color: var(--text-primary); margin: 0 0 12px; }
  .brm-body { font-size: 0.88rem; color: var(--text-secondary); line-height: 1.65; margin: 0 0 14px; }
  .brm-body strong { color: var(--text-primary); }
  .brm-note {
  ...
  .brm-btn-confirm {
    ...
    border: none; color: var(--text-primary); font-size: 0.9rem; font-weight: 700;
  ...
  .brm-btn-cancel:hover { background: var(--bg-card); color: var(--text-primary); }
  .platform-wrapper {
  position: relative;
