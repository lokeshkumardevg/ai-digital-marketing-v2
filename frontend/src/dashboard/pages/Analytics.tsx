    ...
    <div className="animate-fade-in" style={{ paddingBottom: '40px' }}>
      ...
      <GlassCard style={{ padding: '32px' }}>
        <h3 style={{ fontSize: '1.2rem', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          <TrendingUp size={18} color="#0665ff" /> Traffic & Revenue Trajectory <span style={{ fontSize: '0.75rem', fontWeight: 'normal', color: 'var(--text-secondary)', marginLeft: '8px' }}>(Historical + 7d AI Projection)</span>
        </h3>
