...
const ALL_TEMPLATES: CampaignTemplate[] = [
  ...
  },
  {
    ...
    platforms: ['Google Search', 'Meta Ads', 'X Ads'],
    goal: 'Generate Leads',
    dailyBudget: '$800/day',
  ...
  },
  {
    ...
    platforms: ['Google Search', 'LinkedIn', 'Meta Ads', 'X Ads'],
    goal: 'Generate Leads',
  ...
  },
  {
    ...
    platforms: ['Instagram', 'Meta Ads', 'Google Maps', 'X Ads'],
    goal: 'Drive Sales',
    dailyBudget: '$600/day',
  ...
  },
  {
    ...
    platforms: ['Meta Ads', 'Google Search', 'LinkedIn Ads'],
    goal: 'Generate Leads',
  ...
  },
  {
    ...
    platforms: ['Google Search', 'Meta Ads', 'YouTube', 'X Ads'],
    goal: 'Generate Leads',
  ...
  },
  {
    ...
    platforms: ['Instagram', 'Meta Ads', 'YouTube', 'X Ads', 'LinkedIn Ads'],
